...
const IndividualBlance = ({ balance, user, group }) => {
    ...
    <div className={classes.root}>
      <Paper className={classes.paper} variant="outlined">
        <Accordion>
          ...
          {groups.map((group) => {
            // console.log(group);
            const groupName = getGroupFromId(Object.keys(group)[0]);
            const amount = Object.values(group)[0].toFixed(2);
            return (
              <Grid
                className={classes.gs}
                container
                direction="row"
                justify="space-around"
                alignItems="center"
...
export default IndividualBlance;
